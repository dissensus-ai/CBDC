...
\input{tables/independent.tex}\end{tabular}
\end{table}
...
\input{tables/levels.tex}\end{tabular}
\end{table}
\begin{figure}[htbp]\centering\includegraphics[width=.94\linewidth]{figures/independent.pdf}\caption{Customer-attribute and watchlist increments on the operational endpoint. Bars are paired mean reductions in missed cases; points and whiskers show means and pointwise 90\% intervals.}\label{fig:independent}\end{figure}
...
\input{tables/ladder.tex}\end{tabular}
\end{table}
...
\input{tables/ladder-ops.tex}\end{tabular}
\end{table}
\begin{figure}[htbp]\centering\includegraphics[width=.94\linewidth]{figures/ladder.pdf}\caption{AP increments from attributes and the watchlist across the four models. Intervals are computed on paired within-world increments. The four labels denote model families, not a validated scalar scale of capacity.}\end{figure}
...
\input{tables/surface.tex}\end{tabular}
\end{table}
\begin{figure}[htbp]\centering\includegraphics[width=\linewidth]{figures/surface.pdf}\caption{The combined AP increment above linkage by generated regime. The common color scale preserves the relative magnitude across models. Every panel is at the executed 5\% prevalence; it is not the 3\% surface named in the original plan.}\end{figure}
...
\input{tables/resolution.tex}\end{tabular}
\end{table}
...
\input{tables/positive.tex}\end{tabular}
\end{table}
\begin{table}[H]\centering\small
...
\input{tables/negative.tex}\end{tabular}
\end{table}
...
% let long report URLs break after hyphens in the reference list only
